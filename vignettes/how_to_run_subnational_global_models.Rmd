...
1. Get your global correlations - this data is preloaded for the global subnational correlations between the rates of change in supplies of methods in the public and provate sectors. However, if you wish to calculate your own global correlations, please see the 'data_raw/estimated_global_subnational_correlations.R' file for an instruction on how to do so. 
...
We can review the model plots by navigating to the pathway labelled as 'vis_path' from the 'plot_point_estimates' function above.

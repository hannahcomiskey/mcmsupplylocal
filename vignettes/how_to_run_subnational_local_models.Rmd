...
```{r, include=TRUE, message=FALSE}
load("data/sigma_delta_hat.rda")
load("data/median_alphacms.rda")
load("data/tau_alpha_pms_hat.rda")
...
```{r, message=FALSE, eval=FALSE}
get_P_point_estimates(main_path = "results/local_spatial/", pkg_data, local=TRUE, spatial=TRUE, mycountry="Nepal")
```
...
plot_point_estimates(main_path = "results/local_spatial/", pkg_data = pkg_data, vis_path = "visualisations/local_spatial/", local=TRUE, mycountry="Nepal")
```
